...
import { Search, Settings, HelpCircle, LogOut, User as UserIcon } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
            ...
            <DropdownMenuLabel className="font-normal">
              <div className="flex flex-col space-y-1">
                <p className="text-sm font-medium leading-none text-brand-primary">
                  {authUser?.name || 'SanityFlow Admin'}
                </p>
                <p className="text-xs leading-none text-brand-gray">
                  {authUser?.email || 'admin@sanityflow.com'}
                </p>
                <p className="text-[10px] font-semibold tracking-wider text-brand-secondary mt-1 uppercase">
                  {authUser?.role || 'admin'}
                </p>
              </div>
            </DropdownMenuLabel>
